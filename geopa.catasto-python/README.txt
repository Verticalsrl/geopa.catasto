...
geopa.catasto is a library for parsing and translating
official land registry data published by the "Agenzia
del Territorio" into more standard GIS formats.

It currently support CXF/SUP map files and FAB/TER/TIT/SOG
censo data, and .DAT files for DocFa planimetry
